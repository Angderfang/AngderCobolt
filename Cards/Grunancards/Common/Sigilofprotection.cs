...
internal sealed class Sigil : Card, IAngderCard
{
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("Sigil", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "Sigil", "name"]).Localize
        });
    }
