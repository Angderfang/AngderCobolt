...
namespace Angder.EchoesOfTheFuture.Features;
    ...
    public override Spr? GetIcon()
        ...
        public override List<Tooltip> GetTooltips()
        {
            ...
            string description;
            ISpriteEntry icon;
            icon = ModEntry.Instance.ShieldIcon;
            ...
            description = Health == 5 ? ModEntry.Instance.Localizations.Localize(["Midrow", "MidShield", "description", "full"]) : Health == 4 ? ModEntry.Instance.Localizations.Localize(["Midrow", "MidShield", "description", "damaged"]) : Health == 3 ? ModEntry.Instance.Localizations.Localize(["Midrow", "MidShield", "description", "quitedamaged"]) : Health == 2 ? ModEntry.Instance.Localizations.Localize(["Midrow", "MidShield", "description", "verydamaged"]) : ModEntry.Instance.Localizations.Localize(["Midrow", "MidShield", "description", "Lastlegs"]);
